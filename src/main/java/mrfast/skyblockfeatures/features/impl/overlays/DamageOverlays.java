...
public class DamageOverlays {
    ...
    // @SubscribeEvent
    // public void onRenderHealth(RenderGameOverlayEvent event) {
    //     if (event.type == RenderGameOverlayEvent.ElementType.HEALTH && Utils.inSkyblock && skyblockfeatures.config.damagetint) {
