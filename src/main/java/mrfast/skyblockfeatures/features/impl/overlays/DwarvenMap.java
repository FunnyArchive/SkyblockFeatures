...
public class DwarvenMap {
    ...
    public static class DwarvenMapGui extends GuiElement {
        public DwarvenMapGui() {
            super("Dwarven Mines Map", new FloatPair(0, 5));
        ...
        public void render() {
            try {
                ...
                if (loaded && Minecraft.getMinecraft().thePlayer != null && Utils.inSkyblock && Minecraft.getMinecraft().theWorld != null && skyblockfeatures.config.dwarvenMinesMap && SBInfo.getInstance().getLocation().equals("mining_3")) {
