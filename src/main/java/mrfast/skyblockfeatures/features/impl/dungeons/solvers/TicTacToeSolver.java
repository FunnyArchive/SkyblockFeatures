...
import mrfast.skyblockfeatures.utils.TicTacToeUtils;
import mrfast.skyblockfeatures.utils.Utils;
/**
 * Taken from Danker's Skyblock Mod under GPL 3.0 license and modified by MrFast
...
public class TicTacToeSolver {
    ...
    public void onWorldRender(RenderWorldLastEvent event) {
        if (correctTicTacToeButton != null) {
            RenderUtil.drawOutlinedFilledBoundingBox(correctTicTacToeButton, new Color(0,255,255), event.partialTicks);
        }
    }
