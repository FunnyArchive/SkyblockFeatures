...
public class DungeonBlocks {
    ...
    public static boolean isOverriding() {
        return OpenGlHelper.isFramebufferEnabled() && skyblockfeatures.config.dungeonBlocks;
    }
