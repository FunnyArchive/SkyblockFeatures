                        ...
                        if (auctionIdentifier != null) {
                            ...
                            for(String line : ItemUtil.getItemLore(stack)) {
                                ...
                                if(line.contains("Ends in: ")) {
                                    endTime = Utils.cleanColour(line).replace("Ends in: ", "");
                                }
                ...
                for(Slot slot:gui.inventorySlots.inventorySlots) {
                    if (slot.getHasStack() && slot.getSlotIndex() == 13 && !alreadyGotIt) {
                        ...
                        if (auctionIdentifier != null) {
                            ...
                            Integer sellingFor = Integer.parseInt(Utils.cleanColour(inv.getStackInSlot(31).getDisplayName()).split(" ")[2].replaceAll("[^0-9]", ""));
