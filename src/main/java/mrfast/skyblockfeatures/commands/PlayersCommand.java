...
public class PlayersCommand extends CommandBase {
	...
	public static String usage(ICommandSender arg0) {
		return new PlayersCommand().getCommandUsage(arg0);
	}
	...
	public void processCommand(ICommandSender arg0, String[] arg1) throws CommandException {
		...
		new Thread(() -> {
			...
			JsonObject playersResponse = APIUtil.getResponse(playersURL);
			...
			player.addChatMessage(new ChatComponentText(EnumChatFormatting.AQUA.toString() + EnumChatFormatting.STRIKETHROUGH.toString() + "" + EnumChatFormatting.BOLD + "-------------------\n" +
														...
														EnumChatFormatting.GREEN + " Dwarven Mines: " + EnumChatFormatting.DARK_GREEN + nf.format(dwarvenMines) + " / " + Utils.getPercentage(dwarvenMines, skyblockTotalPlayers) + "%\n" +
